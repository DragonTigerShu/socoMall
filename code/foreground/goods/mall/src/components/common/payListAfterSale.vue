<template>
  <div class="payListAfterSale">
    ...
    <section>
      <displayQuestion :isShow="true" :cover="true" @clickListen="questionListen"></displayQuestion>
    </section>
  </div>
</template>
  ...
  export default {
    ...
    methods:{
      AliPayListen:function(){
        ...
        .then((response) => {
          ...
          {
            setStorage("alipay",data.data.alipay_res);
    ...
    WeChatListen:function(){
      if(this.orderId!=null){
        ...
        //   else
        //   {
        //     newWin.location.href = 'http://wx.supersoco.com/scshop/server/index.php?c=Pay&m=testWe&order_sn='+this.orderSn;
        //    // window.location.href=window.location. origin + '/pay.html';
        //   }
        // })
        // .catch(function (error) {
        //   overflowDisabled(false);
