<template>
	<div class="info_aftersale_cation_three">
		...
		<div class="info_aftersale_bottom">
			...
			<h3>服务类型</h3>
			<Sale_refund style="margin-bottom:40px" :recId="parseInt(recId)" :infoIndex="2"></Sale_refund>
			<div class="info_after_state">
				...
				<div class="info_state_add">
					<h3>收货地址:</h3>
					<aL :reload="reload" @selectListen="selectAddressListen" @appListen="appListen"></aL>  <!--收货地址-->
...
<script>
	...
	var $this={}
	export default{
   	name:'info_afterSale_cation_three', //换货
   		...
   		initOrder:function(){
		      ...
		      switch(parseInt(response.data.code)){
		      	case 1600100 :{
		      		...
		      		$this.money=$this.data['order_info']['total_amount'];
