<template>
	<div class="info_aftersale_cation_two">
		<div class="info_aftersale w">
			<div class="soco_details_right_top info_aftersale_cation">
				...
				<info_drawback :drawack="1" :infoIndex="0"></info_drawback>
			</div>
		</div>
		<div class="info_aftersale_bottom">
			...
			<h3>服务类型</h3>
			<Sale_refund style="margin-bottom:40px" :recId="parseInt(recId)" :infoIndex="1"></Sale_refund>
...
<script>
	...
	var $this={}
	export default{
   	name:'info_afterSale_cation_two', //退货退款
   	components:{
   	...
   	methods:{
   		...
   		cation_button:function(){
   			if($this.reason==null||$this.reason==''){
   				...
   				$this.reasonErrorText='请选择退货原因';
   				$this.$emit("appListen","inform","请选择退货原因");
   				return false;
   			}
