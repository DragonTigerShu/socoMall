<template>
	<div class="info_aftersale_cation_one_application_edit" v-if="data['return_goods_info']">
		...
		<div class="info_aftersale_bottom">
			...
			<h3>服务类型</h3>
			<Sale_refund style="margin-bottom:20px" :id="parseInt(data['return_goods_info']['id'])" :infoIndex="0"></Sale_refund>
			<div class="info_after_state">
				...
				<div class="info_state_three">
					...
					<div>
						...
						<span>*最大退款金额{{data['order_goods_info']['goods_price']*data['order_goods_info']['goods_number']}}元</span>
					</div>
				</div>
