<template>
   ...
   <div class="info_aftersale w">
     <div class="soco_details_right_top info_aftersale_cation">
       ...
       <h3 slot="info_header-title" class="info_header-title">退款申请</h3>
       </info_title>
       <info_drawback :drawack="0" :infoIndex="parseInt(infoIndex)"></info_drawback>
...
<script>
 ...
 let $this ={}
 export default{
   	name:'info_aftersale_cation_one_application', //退款
    components:{
